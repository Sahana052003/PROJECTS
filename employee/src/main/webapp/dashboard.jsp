  ...
  <div class="container-fluid navbar-container">
    ...
    <div class="nav-right">
      <a class="btn-gradient-purple"
         href="editProfile?id=${loggedInUser.id}">
        Edit Profile
      </a>
      <a class="btn-gradient-purple" href="login">
        Logout
      </a>
    </div>
  </div>
...
<div class="container mt-4">
  ...
  <table class="profile-table">
    ...
    <tbody>
      ...
      <tr>
        <td>Mobile Number</td>
        <td>${loggedInUser.mobileNumber}</td>
        <td><span class="badge-green">Saved</span></td>
      </tr>
      <tr>
        <td>Age</td>
        <td>${loggedInUser.age} years</td>
      ...
      <tr>
        ...
        <td>
          <c:choose>
            <c:when test="${loggedInUser.gender eq 'Male'}">
              <span class="badge-purple">Male</span>
            </c:when>
            <c:when test="${loggedInUser.gender eq 'Female'}">
              <span class="badge-pink">Female</span>
            </c:when>
            <c:otherwise>
              <span class="badge-green">Other</span>
            </c:otherwise>
          </c:choose>
        </td>
      </tr>
